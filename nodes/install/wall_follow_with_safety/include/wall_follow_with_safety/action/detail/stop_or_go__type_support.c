...
#include <stddef.h>
#include "wall_follow_with_safety/action/detail/stop_or_go__rosidl_typesupport_introspection_c.h"
#include "wall_follow_with_safety/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_Goal__init(message_memory);
}

void StopOrGo_Goal__rosidl_typesupport_introspection_c__StopOrGo_Goal_fini_function(void * message_memory)
{
  wall_follow_with_safety__action__StopOrGo_Goal__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_Goal__rosidl_typesupport_introspection_c__StopOrGo_Goal_message_member_array[1] = {
  {
    ...
    offsetof(wall_follow_with_safety__action__StopOrGo_Goal, stop),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_Goal__rosidl_typesupport_introspection_c__StopOrGo_Goal_message_members = {
  "wall_follow_with_safety__action",  // message namespace
  "StopOrGo_Goal",  // message name
  1,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_Goal),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_Result__init(message_memory);
}

void StopOrGo_Result__rosidl_typesupport_introspection_c__StopOrGo_Result_fini_function(void * message_memory)
{
  wall_follow_with_safety__action__StopOrGo_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_Result__rosidl_typesupport_introspection_c__StopOrGo_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_Result, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_Result__rosidl_typesupport_introspection_c__StopOrGo_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_Feedback__init(message_memory);
}

void StopOrGo_Feedback__rosidl_typesupport_introspection_c__StopOrGo_Feedback_fini_function(void * message_memory)
{
  wall_follow_with_safety__action__StopOrGo_Feedback__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember StopOrGo_Feedback__rosidl_typesupport_introspection_c__StopOrGo_Feedback_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_Feedback, current_distance_to_wall),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_Feedback, ittc),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_Feedback__rosidl_typesupport_introspection_c__StopOrGo_Feedback_message_members = {
  ...
  2,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_Feedback)() {
...
// Member `goal`
#include "wall_follow_with_safety/action/stop_or_go.h"
// Member `goal`
// already included above
// #include "wall_follow_with_safety/action/detail/stop_or_go__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_SendGoal_Request__init(message_memory);
}
...
{
  wall_follow_with_safety__action__StopOrGo_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_SendGoal_Request__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_SendGoal_Request__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_SendGoal_Response__init(message_memory);
}
...
{
  wall_follow_with_safety__action__StopOrGo_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_SendGoal_Response__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_SendGoal_Response__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_members = {
  "wall_follow_with_safety__action",  // service namespace
  "StopOrGo_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_type_support_handle = {
  0,
  &wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_SendGoal)() {
  if (!wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_type_support_handle.typesupport_identifier) {
    wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_SendGoal_Response)()->data;
  }

  return &wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_GetResult_Request__init(message_memory);
}
...
{
  wall_follow_with_safety__action__StopOrGo_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_GetResult_Request__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_GetResult_Request__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_GetResult_Response__init(message_memory);
}
...
{
  wall_follow_with_safety__action__StopOrGo_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_GetResult_Response__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_GetResult_Response__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_members = {
  "wall_follow_with_safety__action",  // service namespace
  "StopOrGo_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_type_support_handle = {
  0,
  &wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_GetResult)() {
  if (!wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_type_support_handle.typesupport_identifier) {
    wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_GetResult_Response)()->data;
  }

  return &wall_follow_with_safety__action__detail__stop_or_go__rosidl_typesupport_introspection_c__StopOrGo_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  wall_follow_with_safety__action__StopOrGo_FeedbackMessage__init(message_memory);
}
...
{
  wall_follow_with_safety__action__StopOrGo_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember StopOrGo_FeedbackMessage__rosidl_typesupport_introspection_c__StopOrGo_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(wall_follow_with_safety__action__StopOrGo_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StopOrGo_FeedbackMessage__rosidl_typesupport_introspection_c__StopOrGo_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(wall_follow_with_safety__action__StopOrGo_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_wall_follow_with_safety
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wall_follow_with_safety, action, StopOrGo_FeedbackMessage)() {
