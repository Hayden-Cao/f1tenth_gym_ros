...
class Init_Stop_Goal_stop_required
{
public:
  Init_Stop_Goal_stop_required()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::custom_interfaces::action::Stop_Goal stop_required(::custom_interfaces::action::Stop_Goal::_stop_required_type arg)
  {
    msg_.stop_required = std::move(arg);
...
{
  return custom_interfaces::action::builder::Init_Stop_Goal_stop_required();
}
...
class Init_Stop_Result_speed_zero
{
public:
  Init_Stop_Result_speed_zero()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::custom_interfaces::action::Stop_Result speed_zero(::custom_interfaces::action::Stop_Result::_speed_zero_type arg)
  {
...
{
  return custom_interfaces::action::builder::Init_Stop_Result_speed_zero();
}
...
class Init_Stop_Feedback_stop_msg
{
public:
  Init_Stop_Feedback_stop_msg()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::custom_interfaces::action::Stop_Feedback stop_msg(::custom_interfaces::action::Stop_Feedback::_stop_msg_type arg)
  {
    msg_.stop_msg = std::move(arg);
    return std::move(msg_);
  }
...
{
  return custom_interfaces::action::builder::Init_Stop_Feedback_stop_msg();
}
