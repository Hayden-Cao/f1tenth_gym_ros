...
stop_interfaces__action__StopOrGo_Goal__create()
{
  ...
  stop_interfaces__action__StopOrGo_Goal * msg = (stop_interfaces__action__StopOrGo_Goal *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_Goal));
  bool success = stop_interfaces__action__StopOrGo_Goal__init(msg);
  if (!success) {
...
stop_interfaces__action__StopOrGo_Goal__destroy(stop_interfaces__action__StopOrGo_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stop_interfaces__action__StopOrGo_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stop_interfaces__action__StopOrGo_Goal__Sequence__init(stop_interfaces__action__StopOrGo_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Goal * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_Goal *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_Goal__fini(&data[i - 1]);
      }
...
stop_interfaces__action__StopOrGo_Goal__Sequence__fini(stop_interfaces__action__StopOrGo_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Goal__Sequence * array = (stop_interfaces__action__StopOrGo_Goal__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_Goal__Sequence__init(array, size);
  if (!success) {
...
stop_interfaces__action__StopOrGo_Goal__Sequence__destroy(stop_interfaces__action__StopOrGo_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_Goal__Sequence__are_equal(const stop_interfaces__action__StopOrGo_Goal__Sequence * lhs, const stop_interfaces__action__StopOrGo_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_Goal);
    stop_interfaces__action__StopOrGo_Goal * data =
      (stop_interfaces__action__StopOrGo_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Result * msg = (stop_interfaces__action__StopOrGo_Result *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_Result));
  bool success = stop_interfaces__action__StopOrGo_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_Result__destroy(stop_interfaces__action__StopOrGo_Result * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stop_interfaces__action__StopOrGo_Result__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stop_interfaces__action__StopOrGo_Result__Sequence__init(stop_interfaces__action__StopOrGo_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Result * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_Result *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_Result__Sequence__fini(stop_interfaces__action__StopOrGo_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Result__Sequence * array = (stop_interfaces__action__StopOrGo_Result__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_Result__Sequence__destroy(stop_interfaces__action__StopOrGo_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_Result__Sequence__are_equal(const stop_interfaces__action__StopOrGo_Result__Sequence * lhs, const stop_interfaces__action__StopOrGo_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_Result);
    stop_interfaces__action__StopOrGo_Result * data =
      (stop_interfaces__action__StopOrGo_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_Feedback__init(stop_interfaces__action__StopOrGo_Feedback * msg)
{
  ...
  // current_movement
  if (!rosidl_runtime_c__String__init(&msg->current_movement)) {
    stop_interfaces__action__StopOrGo_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
stop_interfaces__action__StopOrGo_Feedback__fini(stop_interfaces__action__StopOrGo_Feedback * msg)
{
  ...
  // current_movement
  rosidl_runtime_c__String__fini(&msg->current_movement);
}
...
stop_interfaces__action__StopOrGo_Feedback__are_equal(const stop_interfaces__action__StopOrGo_Feedback * lhs, const stop_interfaces__action__StopOrGo_Feedback * rhs)
{
  ...
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->current_movement), &(rhs->current_movement)))
  {
    return false;
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_Feedback * output)
{
  ...
  if (!rosidl_runtime_c__String__copy(
      &(input->current_movement), &(output->current_movement)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Feedback * msg = (stop_interfaces__action__StopOrGo_Feedback *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_Feedback));
  bool success = stop_interfaces__action__StopOrGo_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_Feedback__Sequence__init(stop_interfaces__action__StopOrGo_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Feedback * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_Feedback *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_Feedback__Sequence__fini(stop_interfaces__action__StopOrGo_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_Feedback__Sequence * array = (stop_interfaces__action__StopOrGo_Feedback__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_Feedback__Sequence__destroy(stop_interfaces__action__StopOrGo_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_Feedback__Sequence__are_equal(const stop_interfaces__action__StopOrGo_Feedback__Sequence * lhs, const stop_interfaces__action__StopOrGo_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_Feedback);
    stop_interfaces__action__StopOrGo_Feedback * data =
      (stop_interfaces__action__StopOrGo_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_SendGoal_Request__init(stop_interfaces__action__StopOrGo_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    stop_interfaces__action__StopOrGo_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!stop_interfaces__action__StopOrGo_Goal__init(&msg->goal)) {
    stop_interfaces__action__StopOrGo_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
stop_interfaces__action__StopOrGo_SendGoal_Request__fini(stop_interfaces__action__StopOrGo_SendGoal_Request * msg)
{
  ...
  // goal
  stop_interfaces__action__StopOrGo_Goal__fini(&msg->goal);
}
...
stop_interfaces__action__StopOrGo_SendGoal_Request__are_equal(const stop_interfaces__action__StopOrGo_SendGoal_Request * lhs, const stop_interfaces__action__StopOrGo_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!stop_interfaces__action__StopOrGo_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Request * msg = (stop_interfaces__action__StopOrGo_SendGoal_Request *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_SendGoal_Request));
  bool success = stop_interfaces__action__StopOrGo_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__init(stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Request * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_SendGoal_Request *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__fini(stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * array = (stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__destroy(stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence__are_equal(const stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * lhs, const stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_SendGoal_Request);
    stop_interfaces__action__StopOrGo_SendGoal_Request * data =
      (stop_interfaces__action__StopOrGo_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_SendGoal_Response__init(stop_interfaces__action__StopOrGo_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    stop_interfaces__action__StopOrGo_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Response * msg = (stop_interfaces__action__StopOrGo_SendGoal_Response *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_SendGoal_Response));
  bool success = stop_interfaces__action__StopOrGo_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__init(stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Response * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_SendGoal_Response *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__fini(stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * array = (stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__destroy(stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence__are_equal(const stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * lhs, const stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_SendGoal_Response);
    stop_interfaces__action__StopOrGo_SendGoal_Response * data =
      (stop_interfaces__action__StopOrGo_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_GetResult_Request__init(stop_interfaces__action__StopOrGo_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    stop_interfaces__action__StopOrGo_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Request * msg = (stop_interfaces__action__StopOrGo_GetResult_Request *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_GetResult_Request));
  bool success = stop_interfaces__action__StopOrGo_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__init(stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Request * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_GetResult_Request *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__fini(stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * array = (stop_interfaces__action__StopOrGo_GetResult_Request__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__destroy(stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_GetResult_Request__Sequence__are_equal(const stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * lhs, const stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_GetResult_Request);
    stop_interfaces__action__StopOrGo_GetResult_Request * data =
      (stop_interfaces__action__StopOrGo_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_GetResult_Response__init(stop_interfaces__action__StopOrGo_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!stop_interfaces__action__StopOrGo_Result__init(&msg->result)) {
    stop_interfaces__action__StopOrGo_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
stop_interfaces__action__StopOrGo_GetResult_Response__fini(stop_interfaces__action__StopOrGo_GetResult_Response * msg)
{
  ...
  // status
  // result
  stop_interfaces__action__StopOrGo_Result__fini(&msg->result);
}
...
stop_interfaces__action__StopOrGo_GetResult_Response__are_equal(const stop_interfaces__action__StopOrGo_GetResult_Response * lhs, const stop_interfaces__action__StopOrGo_GetResult_Response * rhs)
{
  ...
  // result
  if (!stop_interfaces__action__StopOrGo_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Response * msg = (stop_interfaces__action__StopOrGo_GetResult_Response *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_GetResult_Response));
  bool success = stop_interfaces__action__StopOrGo_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__init(stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Response * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_GetResult_Response *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__fini(stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * array = (stop_interfaces__action__StopOrGo_GetResult_Response__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__destroy(stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_GetResult_Response__Sequence__are_equal(const stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * lhs, const stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_GetResult_Response);
    stop_interfaces__action__StopOrGo_GetResult_Response * data =
      (stop_interfaces__action__StopOrGo_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stop_interfaces__action__StopOrGo_FeedbackMessage__init(stop_interfaces__action__StopOrGo_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    stop_interfaces__action__StopOrGo_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!stop_interfaces__action__StopOrGo_Feedback__init(&msg->feedback)) {
    stop_interfaces__action__StopOrGo_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
stop_interfaces__action__StopOrGo_FeedbackMessage__fini(stop_interfaces__action__StopOrGo_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  stop_interfaces__action__StopOrGo_Feedback__fini(&msg->feedback);
}
...
stop_interfaces__action__StopOrGo_FeedbackMessage__are_equal(const stop_interfaces__action__StopOrGo_FeedbackMessage * lhs, const stop_interfaces__action__StopOrGo_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!stop_interfaces__action__StopOrGo_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_FeedbackMessage * msg = (stop_interfaces__action__StopOrGo_FeedbackMessage *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stop_interfaces__action__StopOrGo_FeedbackMessage));
  bool success = stop_interfaces__action__StopOrGo_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__init(stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_FeedbackMessage * data = NULL;

  if (size) {
    data = (stop_interfaces__action__StopOrGo_FeedbackMessage *)allocator.zero_allocate(size, sizeof(stop_interfaces__action__StopOrGo_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stop_interfaces__action__StopOrGo_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stop_interfaces__action__StopOrGo_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__fini(stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stop_interfaces__action__StopOrGo_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * array = (stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence *)allocator.allocate(sizeof(stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__destroy(stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence__are_equal(const stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * lhs, const stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stop_interfaces__action__StopOrGo_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stop_interfaces__action__StopOrGo_FeedbackMessage);
    stop_interfaces__action__StopOrGo_FeedbackMessage * data =
      (stop_interfaces__action__StopOrGo_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stop_interfaces__action__StopOrGo_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          stop_interfaces__action__StopOrGo_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stop_interfaces__action__StopOrGo_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
